    ...
    <>
      <nav className="flex items-center justify-between flex-wrap bg-white p-6 w-full text-base  font-medium tracking-wide">
        ...
        <div className="flex items-center flex-shrink-0 text-black mr-6">
          ...
          <div className="px-5">
            <Link href="" className="p-2 hover:border-b-4 hover:border-orange-400">About us</Link>
            </div>
          <div className="px-5">
            <Link href="" className="p-2 hover:border-b-4 hover:border-orange-400">Benefits</Link>
            </div>
          <div className="px-5">
            <Link href="" className="p-2 hover:border-b-4 hover:border-orange-400">Contact us</Link>
            </div>
        </div>
