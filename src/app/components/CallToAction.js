        ...
        <>
                ...
                <div className="flex items-center justify-between flex-wrap  w-full text-base  font-medium tracking-wide p-6  relative top-[5vw]">
                    ...
                    <div className="  mx-auto py-4">
                        <button className=" rounded-full bg-orange-400 text-white hover hover:bg-orange-500 hover:shadow-lg hover:-translate-y-1 w-96  px-5 py-3 transition duration-150">Start playing XO</button>
                    </div>
